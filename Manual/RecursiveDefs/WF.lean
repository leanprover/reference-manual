...
{docstring WellFoundedRelation (allowMissing := true)}
...
{docstring WellFounded.fix (allowMissing := true)}
...
{docstring invImage (allowMissing := true)}
...
{docstring WellFounded (allowMissing := true)}
